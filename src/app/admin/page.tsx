        ...
        <div className="mb-5 flex h-[81%] w-[90%] flex-col items-center justify-center text-center">
          <div className="flex h-full w-full flex-col md:flex-row">
            ...
            <div className="flex h-full w-full flex-col gap-5 p-5 text-white md:w-1/3">
              <div className="flex h-1/2 md:h-1/3 items-center justify-center rounded-lg bg-black/50 text-2xl font-bold text-primary">
                <p>
                  Total Donations: <br />
            ...
            <div className="flex h-full w-full flex-col text-white md:w-2/3">
              {/* Graph Section */}
              <div className="h-[50%] rounded-lg bg-black/50 p-5 md:h-[60%]">
              ...
              <div className="mt-5 flex h-[50%] items-center justify-center rounded-lg bg-black/50 text-2xl font-bold text-primary md:h-[40%]">
                <p>DUMMY</p>
              </div>
            </div>
          </div>
